// In atom server.js
app.get('/',function(request,response){     // "app.get()" get the request from browser and to send it server. This method takes two parameter. First one '/', this represents the location of Root(Server), where requested to be rooted.
