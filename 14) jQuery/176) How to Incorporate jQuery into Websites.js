...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <script src="index.js" charset="utf-8"></script>        // Always, include jQuery cdn and javascript source at the end of body section. If we include these two lines of code in head section, after link then include these three lines of code as below line number 28-30, because, their javascript code will execute before jQuery CDN is loaded. So, to make sure that jQuery document is ready, include those line of code from 28-30.
  </body>
</html>
